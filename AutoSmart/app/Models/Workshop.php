...
class Workshop extends Model
{
    ...
    public function services(): HasMany { return $this->hasMany(WorkshopService::class); }
    public function quotes(): HasMany { return $this->hasMany(MaintenanceQuote::class); }
    public function bookings(): HasMany { return $this->hasMany(MaintenanceBooking::class); }
    public function reviews(): HasMany { return $this->hasMany(WorkshopReview::class); }
