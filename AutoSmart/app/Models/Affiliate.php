...
class Affiliate extends Model
{
    ...
    public function sales(): HasMany { return $this->hasMany(AffiliateSale::class); }
    public function payouts(): HasMany { return $this->hasMany(AffiliatePayout::class); }

    public function scopeApproved($query) { return $query->where('status', 'approved'); }
    public function canRequestPayout(): bool { return $this->pending_earnings >= $this->minimum_payout; }
