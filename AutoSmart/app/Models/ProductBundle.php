...
class ProductBundle extends Model
{
    ...
    public function items(): HasMany { return $this->hasMany(BundleItem::class, 'bundle_id'); }
    public function products(): BelongsToMany { return $this->belongsToMany(Product::class, 'bundle_items', 'bundle_id', 'product_id')->withPivot('quantity'); }
    ...
    public function getSavingsPercentageAttribute(): int { return $this->regular_price > 0 ? round((($this->regular_price - $this->bundle_price) / $this->regular_price) * 100) : 0; }
}
