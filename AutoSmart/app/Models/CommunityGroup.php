...
class CommunityGroup extends Model
{
    ...
    public function carBrand(): BelongsTo { return $this->belongsTo(CarBrand::class); }
    public function members(): BelongsToMany { return $this->belongsToMany(User::class, 'group_members')->withPivot('role')->withTimestamps(); }
    public function posts(): HasMany { return $this->hasMany(GroupPost::class, 'group_id'); }

    public function scopePublic($query) { return $query->where('type', 'public'); }
    ...
    public function isMember(User $user): bool { return $this->members()->where('user_id', $user->id)->exists(); }
}
