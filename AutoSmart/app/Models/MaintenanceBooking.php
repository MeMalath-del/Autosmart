...
class MaintenanceBooking extends Model
{
    ...
    public function service(): BelongsTo { return $this->belongsTo(WorkshopService::class, 'workshop_service_id'); }
    public function maintenanceRequest(): BelongsTo { return $this->belongsTo(MaintenanceRequest::class); }
    public function quote(): BelongsTo { return $this->belongsTo(MaintenanceQuote::class, 'maintenance_quote_id'); }
