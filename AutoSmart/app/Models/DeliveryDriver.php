...
class DeliveryDriver extends Model
{
    ...
    public function trackings(): HasMany { return $this->hasMany(DeliveryTracking::class, 'driver_id'); }
    public function locations(): HasMany { return $this->hasMany(DriverLocation::class, 'driver_id'); }
