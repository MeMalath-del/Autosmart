...
class NotificationCampaign extends Model
{
    ...
    {
        return $this->total_recipients > 0 ? ($this->opened_count / $this->total_recipients) * 100 : 0;
    }

    public function getClickRateAttribute(): float
    {
        return $this->total_recipients > 0 ? ($this->clicked_count / $this->total_recipients) * 100 : 0;
    }
}
